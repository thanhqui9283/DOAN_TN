...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TMDTShop.Models.Account", b =>
                {
            ...
            modelBuilder.Entity("TMDTShop.Models.Attribute", b =>
                {
            ...
            modelBuilder.Entity("TMDTShop.Models.AttributePrice", b =>
                {
            ...
            modelBuilder.Entity("TMDTShop.Models.Brand", b =>
                {
            ...
            modelBuilder.Entity("TMDTShop.Models.Cart", b =>
                {
            ...
            modelBuilder.Entity("TMDTShop.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("TMDTShop.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("TMDTShop.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("TMDTShop.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("TMDTShop.Models.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TMDTShop.Models.Role", b =>
                {
                    b.Property<int>("RoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TMDTShop.Models.Shipper", b =>
                {
            ...
            modelBuilder.Entity("TMDTShop.Models.TransactStatus", b =>
                {
                    b.Property<int>("TransactionStatusId")
                        .HasColumnType("int")
                        .HasColumnName("TransactionStatusID");
            ...
            modelBuilder.Entity("TMDTShop.ViewModel.LoginViewModel", b =>
                {
                    b.Property<string>("UserName")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("TMDTShop.ViewModel.RegisterViewModel", b =>
                {
                    b.Property<int>("CustommerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TMDTShop.Models.Account", b =>
                {
                    b.HasOne("TMDTShop.Models.Role", "Role")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("TMDTShop.Models.AttributePrice", b =>
                {
                    b.HasOne("TMDTShop.Models.Attribute", "Attribute")
                        .WithMany("AttributePrices")
                        .HasForeignKey("AttributeId")
                        .HasConstraintName("FK_AttributePrices_Attribute");

                    b.HasOne("TMDTShop.Models.Product", "Product")
                        .WithMany("AttributePrices")
            ...
            modelBuilder.Entity("TMDTShop.Models.Order", b =>
                {
                    b.HasOne("TMDTShop.Models.Customer", "Customer")
                        .WithMany("Orders")
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("FK_Order_Customers");

                    b.HasOne("TMDTShop.Models.TransactStatus", "TransactionStatus")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("TMDTShop.Models.OrderDetail", b =>
                {
                    b.HasOne("TMDTShop.Models.Order", "Order")
            ...
            modelBuilder.Entity("TMDTShop.Models.Product", b =>
                {
                    b.HasOne("TMDTShop.Models.Brand", "Brand")
                        .WithMany("Products")
                        .HasForeignKey("BrandId")
                        .HasConstraintName("FK_Product_Brand");

                    b.HasOne("TMDTShop.Models.Category", "Cate")
                        .WithMany("Products")
